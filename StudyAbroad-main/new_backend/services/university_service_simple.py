            ...
            with open(self.universities_file, 'r', encoding='utf-8') as file:
                ...
                for uni in universities:
                    normalized_uni = {
                        ...
                        'tuition_fee': uni.get('tuitionFee') or uni.get('tuition_fee', 0),
                        'acceptance_rate': uni.get('acceptanceRate') or uni.get('acceptance_rate', 50),
                        'fields': uni.get('programs') or uni.get('fields', []),
                        'description': uni.get('description', ''),
                        'type': uni.get('type', 'Public'),
                        'min_cgpa': uni.get('min_cgpa', 0),
                        'min_gre': uni.get('min_gre', 0),
                        'min_ielts': uni.get('min_ielts', 0),
                        'min_toefl': uni.get('min_toefl', 0),
                        'international_students': uni.get('internationalStudents') or uni.get('international_students', 0)
                    }
                    normalized.append(normalized_uni)
                return normalized
